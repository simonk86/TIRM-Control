...
<Library LVVersion="13008000">
	...
	<Item Name="support" Type="Folder">
		<Item Name="Capacitive Signal Cluster.ctl" Type="VI" URL="../Capacitive Signal Cluster.ctl"/>
		<Item Name="Hardware Configuration.ctl" Type="VI" URL="../Hardware Configuration.ctl"/>
	</Item>
	<Item Name="Acquire.vi" Type="VI" URL="../Acquire.vi"/>
	<Item Name="Capacitive Message Loop.vi" Type="VI" URL="../Capacitive Message Loop.vi"/>
	<Item Name="Configure.vi" Type="VI" URL="../Configure.vi"/>
	<Item Name="Error From Code.vi" Type="VI" URL="../Error From Code.vi"/>
	<Item Name="Error Handler - Capacitive Message Loop.vi" Type="VI" URL="../Error Handler - Capacitive Message Loop.vi"/>
